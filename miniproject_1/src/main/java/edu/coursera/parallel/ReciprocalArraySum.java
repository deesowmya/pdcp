...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            ...
            if(endIndexExclusive - startIndexInclusive <= 50000) {
                ...
                ReciprocalArraySumTask t1 = new ReciprocalArraySumTask(startIndexInclusive ,mid
                        , input);
    ...
    protected static double parArraySum(final double[] input) {
        ...
        ReciprocalArraySumTask tsk = new ReciprocalArraySumTask(start,endIndex, input);
    ...
    protected static double parManyTaskArraySum(final double[] input,
            final int numTasks) {
        double sum = 0;
        ArrayList<ReciprocalArraySumTask> tskArray = new ArrayList<>();
        ...
        for(int i = 0; i < numTasks; i++){
            ...
            ReciprocalArraySumTask tsk = new ReciprocalArraySumTask(startIndex,endIndex, input);
            tskArray.add(tsk);
        }

        ForkJoinTask.invokeAll(tskArray);
        for(ReciprocalArraySumTask tsk: tskArray){
            sum += tsk.getValue();
        }
        return sum;
    }
